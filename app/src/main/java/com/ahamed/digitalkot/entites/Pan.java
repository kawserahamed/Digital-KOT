...
public class Pan {
    ...
    public Pan(String itemName, int personalPrice, int mediumPrice, int familyPrice) {
    ...
    @Ignore
    public Pan(int id, String itemName, int personalPrice, int mediumPrice, int familyPrice) {
        this.id = id;
        this.itemName = itemName;
        this.personalPrice = personalPrice;
        this.mediumPrice = mediumPrice;
